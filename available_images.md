...
|----------------------------------------------------------------------------------------------|-----------|-------------|------------------------|-------------------------------------------------------------------------------------------|
| DJLServing 0.33.0 LMI container with vLLM 0.8.4                                              | inference | GPU         | 3.11 (py311)           | 763104351884.dkr.ecr.us-west-2.amazonaws.com/djl-inference:0.33.0-lmi15.0.0-cu128         |
| DJLServing 0.32.0 LMI-TRTLLM container with TensorRT-LLM 0.12.0                              | inference | GPU         | 3.10 (py310)           | 763104351884.dkr.ecr.us-west-2.amazonaws.com/djl-inference:0.32.0-tensorrtllm0.12.0-cu125 |
| DJLServing 0.30.0 LMI-Neuron container with Neuron SDK 2.20.1, TransformersNeuronX 0.12.313  | inference | Neuron      | 3.10 (py310)           | 763104351884.dkr.ecr.us-west-2.amazonaws.com/djl-inference:0.30.0-neuronx-sdk2.20.1       |
