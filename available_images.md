...
2. Include fields that will display in your image tables (see [docs/src/tables/](https://github.com/aws/deep-learning-containers/tree/main/docs/src/tables) for table configurations)
