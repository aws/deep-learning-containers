...
# Table of Contents
1. [Constructing image URIs for each region](#Constructing-image-URIs-for-each-region)
2. [DLC Available Image User Guide](#DLC-Available-Image-User-Guide)
   1. [E3 Framework Containers (EC2, ECS, and EKS support only)](#E3-Framework-Containers-(EC2,-ECS,-and-EKS-support-only))
   2. [E3 Framework Graviton Containers (EC2, ECS, and EKS support only)](#E3-Framework-Graviton-Containers-(EC2,-ECS,-and-EKS-support-only))
   3. [SageMaker Framework Containers (SM support only)](#SageMaker-Framework-Containers-(SM-support-only))
   4. [NVIDIA Triton Inference Containers (SM support only)](#NVIDIA-Triton-Inference-Containers-(SM-support-only))
   5. [Habana Training Containers](#Habana-Training-Containers)
   6. [AutoGluon Training Containers](#AutoGluon-Training-Containers)
   7. [AutoGluon Inference Containers](#AutoGluon-Inference-Containers)
   8. [HuggingFace Training Containers](#HuggingFace-Training-Containers)
   9. [HuggingFace Inference Containers](#HuggingFace-Inference-Containers)
   10. [SageMaker Training Compiler Containers](#SageMaker-Training-Compiler-Containers)
   11. [Elastic Inference Containers](#Elastic-Inference-Containers)
   12. [Neuron Inference Containers](#Neuron-Inference-Containers)
   13. [Prior E3 Framework Container Versions](#Prior-E3-Framework-Container-Versions)
   14. [Prior General Framework Container Versions](#Prior-General-Framework-Container-Versions)
   15. [Prior Hugging Face Container Versions](#Prior-Hugging-Face-Container-Versions)
   16. [Prior AutoGluon Container Versions](#Prior-AutoGluon-Container-Versions)
   17. [Prior Elastic Inference Container Versions](#Prior-Elastic-Inference-Container-Versions)
   18. [Prior Neuron Inference Container Versions](#Prior-Neuron-Inference-Container-Versions)
   19. [Prior Habana Training Container Versions](#Prior-Habana-Training-Container-Versions)

# Constructing image URIs for each region

The following table lists ECR Registry URIs that can be used with any DLC image in the supported regions on Amazon EC2, Amazon ECS, Amazon EKS, or Amazon SageMaker. Replace the `<repository-name>` and `<image-tag>` values based on your desired container.

| Region                    | Code           | General Container | Elastic Inference Container | Neuron Container | Example URI                                                                              |
|---------------------------|----------------|-------------------|-----------------------------|------------------|------------------------------------------------------------------------------------------|
...
For prior versions, visit [Prior E3 Framework Container Versions](#Prior-E3-Framework-Container-Versions).
...
For prior versions, visit [Prior General Framework Container Versions](#Prior-General-Framework-Container-Versions)
...
For prior versions, visit [Prior Habana Training Container Versions](#Prior-Habana-Training-Container-Versions)
...
For prior versions, visit [Prior Hugging Face Container Versions](#Prior-Hugging-Face-Container-Versions)
...
For prior versions, visit [Prior Elastic Inference Container Versions](#Prior-Elastic-Inference-Container-Versions)
...
For prior versions, visit [Prior Neuron Inference Container Versions](#Prior-Neuron-Inference-Container-Versions)
