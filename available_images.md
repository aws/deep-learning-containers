...
| Framework         | Arch    | Job Type  | Horovod Options | CPU/GPU 	| Python Version Options | Example URL																						               |
|-------------------|---------|-----------|-----------------|-----------|------------------------|-----------------------------------------------------------------------------------------------------------------|
| PyTorch 1.12.1    | x86_64  | training  | No			    | CPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/pytorch-training:1.12.1-cpu-py38-ubuntu20.04-sagemaker             |
| PyTorch 1.12.1    | x86_64  | training  | Yes			    | GPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/pytorch-training:1.12.1-gpu-py38-cu113-ubuntu20.04-sagemaker       |
| PyTorch 1.12.1    | x86_64  | inference | No			    | CPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/pytorch-inference:1.12.1-cpu-py38-ubuntu20.04-sagemaker            |
| PyTorch 1.12.1    | x86_64  | inference | No			    | GPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/pytorch-inference:1.12.1-gpu-py38-cu113-ubuntu20.04-sagemaker      |
| PyTorch 1.12.1    | aarch64 | inference | No			    | CPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/pytorch-inference-graviton:1.12.1-cpu-py38-ubuntu20.04-sagemaker   |
| MXNet 1.9.0       | x86_64  | training  | Yes			    | CPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/mxnet-training:1.9.0-cpu-py38-ubuntu20.04-sagemaker		           |
| MXNet 1.9.0       | x86_64  | training  | Yes			    | GPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/mxnet-training:1.9.0-gpu-py38-cu112-ubuntu20.04-sagemaker	       |
| MXNet 1.9.0       | x86_64  | inference | No			    | CPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/mxnet-inference:1.9.0-cpu-py38-ubuntu20.04-sagemaker               |
| MXNet 1.9.0       | x86_64  | inference | No			    | GPU 		| 3.8 (py38)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/mxnet-inference:1.9.0-gpu-py38-cu112-ubuntu20.04-sagemaker	       |
| TensorFlow 2.10.0 | x86_64  | training  | Yes			    | CPU 		| 3.9 (py39)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/tensorflow-training:2.10.0-cpu-py39-ubuntu20.04-sagemaker		   |
| TensorFlow 2.10.0 | x86_64  | training  | Yes			    | GPU 		| 3.9 (py39)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/tensorflow-training:2.10.0-gpu-py39-cu112-ubuntu20.04-sagemaker	   |
| TensorFlow 2.10.0 | x86_64  | inference | Yes			    | CPU 		| 3.9 (py39)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/tensorflow-inference:2.10.0-cpu-py39-ubuntu20.04-sagemaker		   |
| TensorFlow 2.10.0 | x86_64  | inference | Yes			    | GPU 		| 3.9 (py39)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/tensorflow-inference:2.10.0-gpu-py39-cu112-ubuntu20.04-sagemaker   |
| TensorFlow 2.10.0 | aarch64 | inference | no			    | CPU 		| 3.9 (py39)			 | 763104351884.dkr.ecr.us-east-1.amazonaws.com/tensorflow-inference-graviton:2.9.1-cpu-py38-ubuntu20.04-sagemaker |
