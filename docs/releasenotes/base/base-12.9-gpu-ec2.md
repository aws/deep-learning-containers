# AWS Deep Learning Containers for Base 12.9 on EC2, ECS, EKS

AWS Deep Learning Containers for EC2, ECS, EKS are now available with Base 12.9.

## Announcements

- Introduced Base containers with CUDA 12.9 for EC2, ECS, EKS
...
763104351884.dkr.ecr.us-west-2.amazonaws.com/base:12.9.1-gpu-py312-cu129-ubuntu22.04-ec2
