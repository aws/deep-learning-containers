# AWS Deep Learning Containers for PyTorch Training 2.9 on EC2, ECS, EKS

AWS Deep Learning Containers for EC2, ECS, EKS are now available with PyTorch 2.9.

## Announcements

- Introduced containers for PyTorch 2.9 for Training on EC2, ECS, EKS
...
763104351884.dkr.ecr.us-west-2.amazonaws.com/pytorch-training:2.9.0-gpu-py312-cu130-ubuntu22.04-ec2
