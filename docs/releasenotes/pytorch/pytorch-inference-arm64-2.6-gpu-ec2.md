# AWS Deep Learning Containers for PyTorch Inference ARM64 2.6 on EC2, ECS, EKS

AWS Deep Learning Containers for EC2, ECS, EKS are now available with PyTorch 2.6.

## Announcements

- Introduced containers for PyTorch 2.6.0 for Inference on EC2, ECS, EKS (ARM64)
...
763104351884.dkr.ecr.us-west-2.amazonaws.com/pytorch-inference-arm64:2.6.0-gpu-py312-cu124-ubuntu22.04-ec2
