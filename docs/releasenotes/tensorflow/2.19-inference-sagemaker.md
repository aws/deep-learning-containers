...
TensorFlow 2.19 Inference and support for CUDA 12.2 on Ubuntu 22.04.

## Release Notes

- Introduced containers of TensorFlow 2.19 for inference on SageMaker.
- For more details on TensorFlow 2.19 Inference DLCs, please refer to
  [v1.1-tf-sagemaker-2.19.0-inf-py312](https://github.com/aws/deep-learning-containers/releases/tag/v1.1-tf-sagemaker-2.19.0-inf-py312).
