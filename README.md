...
- [2025/12/19] We released v0.13.0 [vLLM DLC](https://gallery.ecr.aws/deep-learning-containers/vllm), available in EC2/EKS/ECS `public.ecr.aws/deep-learning-containers/vllm:0.13-gpu-py312-ec2` and SageMaker `public.ecr.aws/deep-learning-containers/vllm:0.13.0-gpu-py312`
