...
def generate_ecr_report_for_image(image_uri, image_info, storage_file_path=None):
    """
    Generate ECR Enchanced scan reports for an image and store it at the location specified
