...
class SafetyReportGenerator:
    ...
    def get_autopatched_dumped_ignore_dict_of_packages(self):
        ...
        dumped_ignore_list_command = f"{self.docker_exec_cmd} cat {constants.PATCHING_INFO_PATH_WITHIN_DLC}/patch-details/vuln_deactivation_data.json"
        return_data = {}
        try:
    ...
    def run_safety_check_in_cb_context(self):
        ...
        try:
            ...
            try:
                ...
                print("DEBUG: SafetyCheck returned invalid JSON, using fallback")
                return self.run_safety_check_in_non_cb_context()
    ...
    def generate(self):
        ...
        print(
            f"DEBUG: safety_check_output length: {len(self.safety_check_output) if self.safety_check_output else 0}"
        )
