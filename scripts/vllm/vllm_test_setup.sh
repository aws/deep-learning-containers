...
# uv pip install -r vllm_source/requirements/common.txt --torch-backend=auto
uv pip install -r vllm_source/requirements/dev.txt
uv pip install pytest pytest-asyncio
uv pip install -e vllm_source/tests/vllm_test_utils
