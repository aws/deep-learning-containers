...
### What to Review
- Verify the generated image tags are correct
- Confirm package versions match the released image
- Check that the YAML file follows the expected format
- Review and adjust the \`announcements\` section (e.g., add "Added Python 3.12 support")
