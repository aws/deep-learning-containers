#!/bin/sh
# Serving entrypoint for the Lambda sglang image.
#
...
#   sglang_entrypoint.sh python -m awslambdaric handler.handler
# so the Runtime Interface Client drives the sglang offline engine wrapped in
