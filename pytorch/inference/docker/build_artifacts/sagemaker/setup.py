...
setup(
    name='sagemaker-pytorch-inferentia-serving-container',
    version='1',
    description='Open source library for creating PyTorch inferentia serving containers to run on Amazon SageMaker.',
    ...
    entry_points={
        'console_scripts': 'serve=sagemaker_pytorch_inferentia_serving_container.serving:main'
    }
)