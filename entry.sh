...
setup_environment_variables() {
    ...
    #export EKS_TEST_ROLE="arn:aws:iam::332057208146:role/clusterManagerRole"
	export BUILD_CONTEXT=PR 
	export REGION=us-west-2 
	export CODEBUILD_RESOLVED_SOURCE_VERSION=chumbalk 
	#export DLC_IMAGES="763104351884.dkr.ecr.us-east-1.amazonaws.com/tensorflow-inference:2.3.1-cpu-py37-ubuntu18.04"
	#export DLC_IMAGES="763104351884.dkr.ecr.us-east-1.amazonaws.com/tensorflow-inference:2.3.1-gpu-py37-cu102-ubuntu18.04"
	export DLC_IMAGES="763104351884.dkr.ecr.us-west-2.amazonaws.com/tensorflow-inference-neuron:1.15.4-neuron-py37-ubuntu18.04"
