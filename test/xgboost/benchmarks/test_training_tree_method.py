...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {"max_depth": "5", "objective": "multi:softmax", "num_class": "10", "num_round": "25"},
            1800,
        ),
        (
            "exact",
        ...
        (
            ...
            {"max_depth": "10", "objective": "reg:squarederror", "num_round": "50"},
            1200,
        ),
        (
            "exact",
...
def test_tree_method(
    image_uri, role, benchmark_bucket, tree_method, dataset_path, extra_hp, timeout
):
