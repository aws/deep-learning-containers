...
@pytest.mark.parametrize(
    ...
    [
        ("25", "xgboost/libsvm/mnist", {"max_depth": "5", "objective": "multi:softmax", "num_class": "10"}, 1200),
        ("50", "xgboost/libsvm/mnist", {"max_depth": "5", "objective": "multi:softmax", "num_class": "10"}, 1800),
        ("100", "xgboost/libsvm/mnist", {"max_depth": "5", "objective": "multi:softmax", "num_class": "10"}, 1800),
        ("50", "xgboost/libsvm/100000x200", {"max_depth": "15", "objective": "reg:squarederror"}, 1200),
        ("100", "xgboost/libsvm/100000x200", {"max_depth": "15", "objective": "reg:squarederror"}, 1200),
        ("200", "xgboost/libsvm/100000x200", {"max_depth": "15", "objective": "reg:squarederror"}, 2400),
    ],
    ids=["mnist-25rounds", "mnist-50rounds", "mnist-100rounds", "synthetic-50rounds", "synthetic-100rounds", "synthetic-200rounds"],
)
