...
BASE_HP = {
    ...
    "objective": "reg:squarederror", "tree_method": "approx", "num_round": "100",
}
...
@pytest.mark.parametrize(
    ...
    ids=["single-m5.large", "single-m5.xlarge", "single-m5.2xlarge", "distributed-m5.large", "distributed-m5.xlarge", "distributed-m5.2xlarge"],
)
def test_instance_type(image_uri, role, benchmark_bucket, instance_type, instance_count, timeout):
    _, duration, desc = run_training_job(
        ...
        hyperparameters=BASE_HP, train_s3_key="xgboost/libsvm/500000x200/train/",
        validation_s3_key="xgboost/libsvm/500000x200/val/", content_type="text/libsvm",
        instance_type=instance_type, instance_count=instance_count, max_run=timeout,
    )
