...
def main():
    ...
    if build_context == "MAINLINE":
        if all("base" in image_uri for image_uri in all_image_list) and test_type not in {
            ...
            return
        elif all("vllm" in image_uri and "huggingface" not in image_uri for image_uri in all_image_list) and test_type not in {
            "functionality_sanity",
            "security_sanity",
            "eks",
            "ec2",
            ...
            return
        elif all("huggingface" in image_uri and "vllm" in image_uri for image_uri in all_image_list) and test_type not in {
            "functionality_sanity",
            "security_sanity",
            "sagemaker",
            "sagemaker-local",
