...
def reupload_image_to_test_ecr(source_image_uri, target_image_repo_name, target_region, pull_image=True):
    ...
    if pull_image:
        LOGGER.info(f"reupload_image_to_test_ecr: pulling https://{image_account_id}.dkr.ecr.{image_region}.amazonaws.com")
        ...
        LOGGER.info(f"reupload_image_to_test_ecr: pulling https://{image_account_id}.dkr.ecr.{image_region}.amazonaws.com completed")
    ...
    LOGGER.info(f"reupload_image_to_test_ecr: pushing https://{image_account_id}.dkr.ecr.{image_region}.amazonaws.com")
    subprocess.check_output(
    ...
    LOGGER.info(f"reupload_image_to_test_ecr: pushing https://{image_account_id}.dkr.ecr.{image_region}.amazonaws.com completed")
    delete_file(ECR_PASSWORD_FILE_PATH)
