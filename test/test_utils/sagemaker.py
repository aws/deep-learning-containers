    ...
    if job_type == "training":
        if framework == "tensorflow":
            if framework_major_version == "2":
                integration_path = f"integration/sagemaker/test_smdataparallel.py::test_distributed_training_smdataparallel_script_mode"
            else:
                integration_path = f"integration/sagemaker/test_tuning_model_dir.py"
        elif framework == "pytorch":
            integration_path = f"integration/sagemaker/test_smdataparallel.py::test_smdataparallel_mnist_script_mode_multigpu"
