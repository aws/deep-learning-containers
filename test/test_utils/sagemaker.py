    ...
    if job_type == "training":
        if framework == "tensorflow":
            if framework_major_version == "2":
                ...
                integration_path = f"integration/sagemaker/test_smdataparallel.py"
        elif framework == "pytorch":
            integration_path = f"integration/sagemaker/test_experiments.py::test_smmodelparallel_smdataparallel_mnist"
