...
def train(num_cpus, num_gpus, channel_input_dirs):
    ...
    try:
        ...
        train_data = np.loadtxt(
            os.path.join(channel_input_dirs["training"], "train_data.txt")
        )
        train_label = np.loadtxt(
            os.path.join(channel_input_dirs["training"], "train_label.txt")
        )
        eval_data = np.loadtxt(
            os.path.join(channel_input_dirs["evaluation"], "eval_data.txt")
        )
        eval_label = np.loadtxt(
            os.path.join(channel_input_dirs["evaluation"], "eval_label.txt")
        )
