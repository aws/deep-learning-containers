...
resnet_neuron_image_list = os.path.join(
    model_neuron_dir, "imagenet1000_clsidx_to_labels.txt"
)
call_model_fn_once_script = os.path.join(
    resources_path, code_sub_dir, "call_model_fn_once.py"
)
