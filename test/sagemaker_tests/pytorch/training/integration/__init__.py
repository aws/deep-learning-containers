...
mnist_script = os.path.join(mnist_path, 'code', 'mnist.py')
...
mnist_1d_script = os.path.join(mnist_path, 'code', 'mnist_1d.py')
...
call_model_fn_once_script = os.path.join(resources_path, 'code', 'call_model_fn_once.py')
