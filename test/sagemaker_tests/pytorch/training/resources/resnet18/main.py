...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if region == "us-west-2":
        ...
        url_list = [
            "s3://pt-s3plugin-test-data-east1/integration_tests/imagenet-train-000000.tar"
        ]
    elif region == "eu-west-1":
        url_list = [
            "s3://pt-s3plugin-test-data-eu-west1/integration_tests/imagenet-train-000000.tar"
        ]
    ...
    train_dataset = ImageNetS3(url_list, transform=preproc)
    train_sampler = None
