...
def main():
    ...
    parser.add_argument("--rows", type=int, default=1, help="Number of rows in the tensor.")
    parser.add_argument("--columns", type=int, default=1, help="Number of columns in the tensor.")
    parser.add_argument(
