...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Preserve the numpy random state between validation",
    )
    parser.add_argument(
        "--fast_validation",
        type=int,
    ...
    lr_grp.add_argument(
        ...
        type=float,
        default=0.01,
        help="Percentage of total iterations to warmup on (.01 = 1 percent of all training iters).",
    )
    lr_grp.add_argument(
        "--plateau",
        type=float,
...
def main():
    ...
    # any value here is overridden by the config set in notebook when launching the sagemaker job
    smp_config = {
        "ddp": True,
    ...
    if args.partition_assignment != "":
        ...
        assert len(partition_assignment) == smp.pp_size(), (
    ...
    if args.manual_partition:
        ...
        if args.partition_assignment != "":
            ...
            assert total_layers == args.num_layers, (
