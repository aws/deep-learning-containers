...
def pytest_configure(config):
    ...
    os.environ["TEST_VERSIONS"] = (
        config.getoption("--versions") or "1.11.1,1.12.0,1.13.0"
    )
    ...
    os.environ["TEST_EI_INSTANCE_TYPES"] = (
        config.getoption("--instance-types") or "ml.m5.xlarge"
    )
