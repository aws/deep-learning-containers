...
def test_model_dir_with_training_job_name(ecr_image, sagemaker_regions, instance_type, framework_version):
    invoke_tf_helper_function(ecr_image, sagemaker_regions, test_model_dir_with_training_job_name_function,
                              instance_type, framework_version)


def test_model_dir_with_training_job_name_function(ecr_image, sagemaker_session, instance_type, framework_version):
