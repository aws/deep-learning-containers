...
def build_record_file(
    filename, num_records, dimension, classes=2, data_feature_name="data", multipart=False
):
...
if __name__ == "__main__":
    ...
    build_record_file(
        args.filename, args.num_records, args.dimension, args.classes, args.data_feature_name
    )
