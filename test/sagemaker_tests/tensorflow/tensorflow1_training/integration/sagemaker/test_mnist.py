...
def test_tf1x_smdebug(sagemaker_session, n_virginia_sagemaker_session, ecr_image, n_virginia_ecr_image, instance_type, framework_version, multi_region_support):
    resource_path = os.path.join(os.path.dirname(__file__), '..', '..', 'resources')
