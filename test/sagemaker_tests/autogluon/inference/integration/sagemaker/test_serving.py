...
from test.sagemaker_tests.autogluon.training.integration import (
...
def _test_sm_trained_model(
    sagemaker_session, ecr_image, instance_type, framework_version
):
...
def test_sm_trained_model_cpu(
    sagemaker_session, framework_version, ecr_image, instance_type
):
