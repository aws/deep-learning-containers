...
@pytest.mark.model("inf-flash-attn")
...
def _test_flash_attn_inf(
    ...
    **kwargs,
    ...
    endpoint_name = sagemaker.utils.unique_name_from_base(
        "sagemaker-huggingface-inference-flash-attn-serving"
    )

    model_data = sagemaker_session.upload_data(
        path=model_dir,
        key_prefix="sagemaker-huggingface-inference-flash-attn-serving/models",
    )

    model_file = pt_model
    entry_point = pt_fa_script
