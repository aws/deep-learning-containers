...
def test_sglang_qwen(framework_version, ecr_image, instance_type, sagemaker_regions):
...
def _test_sglang_model(
    ...
    **kwargs,
    ...
    """Test SGLang model deployment and inference using OpenAI-compatible API format
    ...
    """
    endpoint_name = sagemaker.utils.unique_name_from_base("sagemaker-hf-sglang-serving")
