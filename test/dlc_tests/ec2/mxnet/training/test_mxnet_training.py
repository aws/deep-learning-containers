...
@pytest.mark.parametrize("region,ec2_instance_type", MX_EC2_GPU_INSTANCE_TYPE, indirect=True)
...
@pytest.mark.parametrize("region,ec2_instance_type", MX_EC2_CPU_INSTANCE_TYPE, indirect=True)
