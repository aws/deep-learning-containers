...
def test_ec2_mxnet_squeezenet_inference_gpu(
    ...
    run_ec2_mxnet_inference(
        mxnet_inference, SQUEEZENET_MODEL, "squeezenet", ec2_connection, "gpu", region, 80, 8081
    )
...
def test_ec2_mxnet_squeezenet_inference_cpu(mxnet_inference, ec2_connection, region, cpu_only):
    run_ec2_mxnet_inference(
        mxnet_inference, SQUEEZENET_MODEL, "squeezenet", ec2_connection, "cpu", region, 80, 8081
    )
...
def test_ec2_mxnet_resnet_inference_eia_cpu(mxnet_inference_eia, ec2_connection, region):
    ...
    run_ec2_mxnet_inference(
        mxnet_inference_eia, model_name, "resnet-152-eia", ec2_connection, "eia", region, 80, 8081
    )
