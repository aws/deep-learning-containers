...
PT_EC2_GPU_INSTANCE_TYPE = get_ec2_instance_type(default="p3.16xlarge", processor="gpu")
PT_EC2_MULTI_GPU_NO_G_INSTANCE_TYPE = get_ec2_instance_type(
    default="p3.8xlarge",
    processor="gpu",
    filter_function=ec2_utils.filter_only_multi_gpu_and_no_g_type,
)
PT_EC2_CPU_INSTANCE_TYPE = get_ec2_instance_type(default="c4.8xlarge", processor="cpu")
