...
TEST_EC2_GPU_INSTANCE_TYPE = get_ec2_instance_type(default="g3.4xlarge", processor="gpu")
...
@pytest.mark.parametrize("ec2_instance_type", TEST_EC2_GPU_INSTANCE_TYPE, indirect=True)
@pytest.mark.skipif(TEST_EC2_GPU_INSTANCE_TYPE == ["g3.4xlarge"], reason="Skipping AMP DDP test on single gpu instance")
