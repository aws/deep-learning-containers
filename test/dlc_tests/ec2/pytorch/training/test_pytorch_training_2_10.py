...
def test_pytorch_2_10_gpu(
    pytorch_training___2__10, ec2_connection, region, gpu_only, ec2_instance_type
):
    pytorch_training = pytorch_training___2__10
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.10 GPU")
...
def test_pytorch_2_10_gpu_heavy(
    pytorch_training___2__10, ec2_connection, region, gpu_only, ec2_instance_type
):
    pytorch_training = pytorch_training___2__10
    if test_utils.is_image_incompatible_with_instance_type(pytorch_training, ec2_instance_type):
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.10 GPU Heavy")
...
def test_pytorch_2_10_gpu_inductor(
    pytorch_training___2__10, ec2_connection, region, gpu_only, ec2_instance_type
):
    pytorch_training = pytorch_training___2__10
    if test_utils.is_image_incompatible_with_instance_type(pytorch_training, ec2_instance_type):
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.10 GPU Inductor")
...
def test_pytorch_2_10_cpu(pytorch_training___2__10, ec2_connection, cpu_only):
    pytorch_training = pytorch_training___2__10
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.10 CPU")
