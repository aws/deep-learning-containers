...
def test_pytorch_2_5_gpu(
    pytorch_training___2__5, ec2_connection, region, gpu_only, ec2_instance_type
):
    pytorch_training = pytorch_training___2__5
...
def test_pytorch_2_5_gpu_heavy(
    pytorch_training___2__5, ec2_connection, region, gpu_only, ec2_instance_type
):
    pytorch_training = pytorch_training___2__5
    if test_utils.is_image_incompatible_with_instance_type(pytorch_training, ec2_instance_type):
...
def test_pytorch_2_5_gpu_inductor(
    pytorch_training___2__5, ec2_connection, region, gpu_only, ec2_instance_type
):
    pytorch_training = pytorch_training___2__5
    if test_utils.is_image_incompatible_with_instance_type(pytorch_training, ec2_instance_type):
...
def test_pytorch_2_5_cpu(pytorch_training___2__5, ec2_connection, cpu_only):
    pytorch_training = pytorch_training___2__5
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.5 CPU")
