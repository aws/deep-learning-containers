...
def test_pytorch_2_7_gpu(
    pytorch_training___2__7, ec2_connection, region, gpu_only, ec2_instance_type
):
    pytorch_training = pytorch_training___2__7
...
def test_pytorch_2_7_cpu(pytorch_training___2__7, ec2_connection, cpu_only):
    pytorch_training = pytorch_training___2__7
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.7 CPU")
