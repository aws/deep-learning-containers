...
def test_pytorch_2_8_gpu_heavy(
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.9 GPU Heavy")
...
def test_pytorch_2_8_cpu(pytorch_training___2__8, ec2_connection, cpu_only):
    ...
    test_utils.execute_serial_test_cases(test_cases, test_description="PT 2.9 CPU")
