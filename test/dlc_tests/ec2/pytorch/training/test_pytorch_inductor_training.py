...
PT_MNIST_INDUCTOR_CMD = os.path.join(
    CONTAINER_TESTS_PREFIX, "pytorch_tests", "testPyTorchwithInductor"
)
...
def test_pytorch_with_horovod_inductor(
    ...
    test_cmd = os.path.join(
        CONTAINER_TESTS_PREFIX, "pytorch_tests", "testPTHVDwithInductor"
    )
