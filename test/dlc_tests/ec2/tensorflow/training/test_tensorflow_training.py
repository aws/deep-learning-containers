...
from test.test_utils import CONTAINER_TESTS_PREFIX, DEFAULT_REGION, is_tf1, is_tf20
...
@pytest.mark.skip(reason="Only run standalone gpu")
@pytest.mark.parametrize("region,ec2_instance_type", [(DEFAULT_REGION, "c5.18xlarge")], indirect=True)
