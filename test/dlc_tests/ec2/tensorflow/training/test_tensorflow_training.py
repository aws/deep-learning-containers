...
TF_EC2_GPU_INSTANCE_TYPE = get_ec2_instance_type("g3.16xlarge", "gpu")
...
@pytest.mark.parametrize("ec2_instance_type", get_ec2_instance_type("g3.16xlarge", "gpu"), indirect=True)
...
@pytest.mark.parametrize("ec2_instance_type", get_ec2_instance_type("p2.8xlarge", "gpu"), indirect=True)
