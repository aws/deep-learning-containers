...
from test.test_utils import CONTAINER_TESTS_PREFIX, is_tf1, is_tf22
...
def test_tensorflow_keras_horovod_amp(tensorflow_training, ec2_connection, gpu_only):
    if not is_tf22(tensorflow_training):
        pytest.skip("This test is for TF2.2 only")  # We will explore if this test should also apply to other TF versions
