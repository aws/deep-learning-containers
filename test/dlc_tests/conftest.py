...
def efa_ec2_instances(
    ...
    if num_efa_interfaces > 1:
        ...
        for instance in instances:
            ...
            elastic_ip_allocation_id = ec2_utils.attach_elastic_ip(network_interface_id, region, ENABLE_IPV6_TESTING)
...
def efa_ec2_connections(request, efa_ec2_instances, ec2_key_name, ec2_instance_type, region):
    ...
    if ENABLE_IPV6_TESTING:
        ...
        if master_ipv6_address:
            ...
            LOGGER.info(f"Master node IPv6 address for inter-node communication (eth0): {master_connection.ipv6_address}")
        else:
