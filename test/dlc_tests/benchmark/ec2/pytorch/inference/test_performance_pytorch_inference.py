...
from test.test_utils.ec2 import (
    ec2_performance_upload_result_to_s3_and_validate, post_process_inference)

import pytest
from src.benchmark_metrics import (PYTORCH_INFERENCE_CPU_THRESHOLD,
...
def test_performance_ec2_pytorch_inference_gpu(
    ...
    threshold = get_threshold_for_image(
        framework_version, PYTORCH_INFERENCE_GPU_THRESHOLD
    )
...
def test_performance_ec2_pytorch_inference_cpu(
    ...
    _, framework_version = get_framework_and_version_from_tag(pytorch_inference)
    threshold = get_threshold_for_image(
        framework_version, PYTORCH_INFERENCE_CPU_THRESHOLD
    )
    ec2_performance_pytorch_inference(
        pytorch_inference,
        "cpu",
