...
TF_PERFORMANCE_TRAINING_GPU_SYNTHETIC_CMD = os.path.join(
    CONTAINER_TESTS_PREFIX, "benchmark", f"run_tensorflow_training_performance_gpu_synthetic {BENCHMARK_SETTING}",
)
TF_PERFORMANCE_TRAINING_GPU_IMAGENET_CMD = os.path.join(
    CONTAINER_TESTS_PREFIX, "benchmark", f"run_tensorflow_training_performance_gpu_imagenet {BENCHMARK_SETTING}",
)
