...
def test_performance_ec2_tensorflow_inference_gpu(
    ...
    threshold = get_threshold_for_image(
        framework_version, TENSORFLOW_INFERENCE_GPU_THRESHOLD
    )
...
def test_performance_ec2_tensorflow_inference_cpu(
    ...
    threshold = get_threshold_for_image(
        framework_version, TENSORFLOW_INFERENCE_CPU_THRESHOLD
    )
    ec2_performance_tensorflow_inference(
...
@pytest.mark.parametrize(
    "ec2_instance_ami", [UL20_BENCHMARK_CPU_ARM64_US_WEST_2], indirect=True
)
