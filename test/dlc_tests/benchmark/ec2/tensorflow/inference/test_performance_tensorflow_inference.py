...
import re
import pytest
from src.benchmark_metrics import TENSORFLOW2_INFERENCE_GPU_THRESHOLD, TENSORFLOW2_INFERENCE_CPU_THRESHOLD, \
    TENSORFLOW1_INFERENCE_GPU_THRESHOLD, TENSORFLOW1_INFERENCE_CPU_THRESHOLD
...
def test_performance_ec2_tensorflow_inference_gpu(tensorflow_inference, ec2_connection, region, gpu_only):
    threshold = TENSORFLOW1_INFERENCE_GPU_THRESHOLD if is_tf1(tensorflow_inference)\
...
def test_performance_ec2_tensorflow_inference_cpu(tensorflow_inference, ec2_connection, region, cpu_only):
    threshold = TENSORFLOW1_INFERENCE_CPU_THRESHOLD if is_tf1(tensorflow_inference) \
