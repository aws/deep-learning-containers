...
def test_pip_check(image):
    ...
    if framework == "tensorflow" and Version(framework_version) in SpecifierSet(">=2.9.2"):
        allowed_tf29_exception = re.compile(rf"^(tf-models-official 2.9.2|tensorflow-text 2.9.0) requires tensorflow, which is not installed.")
