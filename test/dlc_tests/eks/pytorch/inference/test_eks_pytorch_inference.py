...
def test_eks_pytorch_neuron_inference(pytorch_inference, neuron_only):
    ...
    search_replace_dict = {
        ...
        "<START_CMD>": "/usr/local/bin/entrypoint.sh -m pytorch-resnet-neuron=https://aws-dlc-sample-models.s3.amazonaws.com//pytorch//Resnet50-neuron.mar -t /home/model-server/config.properties"
    }
    ...
    try:
        ...
        assert test_utils.request_pytorch_inference(model_name=model_name, port=port_to_forward)
