...
if __name__ == '__main__':
    ...
    put_metric_data("Speedup", args.namespace, "None", speedup, dimensions, region)
    put_metric_data("CompilationTime", args.namespace, "Seconds", comp_time, dimensions, region)
    put_metric_data("PeakMemoryFootprintCompressionRatio", args.namespace, "None", memory, dimensions, region)
    #put_metric_data("PassRate", args.namespace, "Percent", passrate, dimensions, region)