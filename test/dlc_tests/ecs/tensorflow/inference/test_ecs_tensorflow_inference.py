...
def test_ecs_tensorflow_inference_cpu(tensorflow_inference, ecs_container_instance, region, cpu_only):
    __ecs_pytorch_inference_cpu(tensorflow_inference, ecs_container_instance, region)
...
def test_ecs_tensorflow_inference_graviton_cpu(tensorflow_inference, ecs_container_instance, region, graviton_only):
    __ecs_pytorch_inference_cpu(tensorflow_inference, ecs_container_instance, region)


def __ecs_pytorch_inference_cpu(tensorflow_inference, ecs_container_instance, region):
