...
def test_ecs_mxnet_inference_cpu(
    mxnet_inference, ecs_container_instance, region, cpu_only
):
...
def test_ecs_mxnet_inference_graviton_cpu(
    ...
    __test_ecs_mxnet_inference_cpu(
        mxnet_inference_graviton, ecs_container_instance, region
    )
...
def test_ecs_mxnet_inference_neuron(
    mxnet_inference_neuron, ecs_container_instance, region
):
    worker_instance_id, ecs_cluster_arn = ecs_container_instance
    public_ip_address = ec2_utils.get_public_ip(worker_instance_id, region=region)
...
def test_ecs_mxnet_inference_gpu(
    mxnet_inference, ecs_container_instance, region, gpu_only
):
    worker_instance_id, ecs_cluster_arn = ecs_container_instance
    public_ip_address = ec2_utils.get_public_ip(worker_instance_id, region=region)
