...
MX_DGL_TRAINING_SCRIPT = os.path.join(
    CONTAINER_TESTS_PREFIX, "dgl_tests", "testMXNetDGL"
)
MX_GLUON_NLP_TRAINING_SCRIPT = os.path.join(
    CONTAINER_TESTS_PREFIX, "gluonnlp_tests", "testNLP"
)
...
@pytest.mark.parametrize(
    "training_script", [MX_GLUON_NLP_TRAINING_SCRIPT], indirect=True
)
